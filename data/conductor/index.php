...
<h3>Durations</h3>
  ...
  <label for="dur">Total duration: minutes</label>
    <input type="number" name="min" size=4 value=<?php echo floor($conf['dur'] / 60); ?>></p><p>
    <label for="dur">seconds</label>
      <input type="number" name="sec" size=4 value=<?php echo floor($conf['dur'] % 60); ?>>
  ...
  <label for="slide_dur">Duration of each page (in seconds):</label>
    <input type="number" name="slide_dur"  size=4 value=<?php echo $conf['slide_dur']; ?>>
  </p>
  <p>
  <label for ="init_sleep">Initial pause (in seconds):</label>
    <input type="number" name="init_sleep"  size=4 value=<?php echo $conf['init_sleep']; ?>>
  </p>
  <h3>Geometry</h3>
      <p>
  ...
  <label for ="imagewidth">Image width:</label>
    <input type="number" name="imagewidth"  size=4 id="imagewidth" value=<?php echo $conf['imagewidth']; ?>>
</p><p>
  <label for ="imageheight">Image height:</label>
    <input type="number" name="imageheight"  size=4 id="imageheight" value=<?php echo $conf['imageheight']; ?>>
  </p>
  <p>
